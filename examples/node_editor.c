...
int node_editor(struct nk_context *ctx, float width_offset, float height_offset) {
    ...
    if (nk_begin(ctx, "Node editor", nk_rect(width_offset, height_offset, 650, 650),
        NK_WINDOW_BORDER|NK_WINDOW_NO_SCROLLBAR|NK_WINDOW_MOVABLE|NK_WINDOW_SCALABLE|NK_WINDOW_CLOSABLE))
    {
